const linesConfig = [
  ...
  'у тебя есть непременённые награды:',
  'Рестарт Сервера',
  'Другие:',
  'Page',
  ...
  'Вы убрали определенное количество монет в кошелек.',
  'Введите в чат сумму для пополнения баланса фракции:',
  '> Игрок',
  'Кто-то разместил новое объявление на досках по всем городам.',
  'Вы запустили',
  'Вы достали некоторое количество монет',
  'You teleported',
  'Загрузка...',
  'Камера установлена в стандартную позицию',
